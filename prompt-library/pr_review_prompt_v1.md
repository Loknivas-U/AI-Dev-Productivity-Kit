...
- Added explicit instruction to flag secrets without echoing values (increased security catch rate)
- Added "candidate gap" framing to reduce false confidence
- Removed instruction to suggest refactors — too noisy, reduced signal score
- Added "What Looks Good" section to balance tone and increase engineer adoption

## Known Weaknesses
- Misses security issues in YAML files (low training coverage)
- Occasionally over-flags medium priority on boilerplate changes
